...
1. 次のコメントを入力し、**Submit review** ボタンをクリックします。
   ...
   <img width="300" alt="Submit review ボタン" src="https://github.com/golondrina1560-tech/skills-review-pull-requests/blob/main/.github/images/submit-review-button.png?raw=true" />
